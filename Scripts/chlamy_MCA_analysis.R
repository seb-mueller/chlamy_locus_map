...
#		 /scripts/conscriptoR /projects/nick_matthews/chlamy_MCA.r -p19
...
save(dimList, file = path.join(saveLocation,"dimList.RData"))
#load("dimList.RData")

# probably not useful as a measure of performance
png(path.join(saveLocation,"kmean_ss.png"))
...
png(path.join(saveLocation,"kmean_randTE.png"))
image(zzz)
dev.off()
