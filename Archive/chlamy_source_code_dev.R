...
phaseMatch2 <- function(locAnn, annoDir = "resources") {
  ...
  require(GenomicRanges)
  require(rtracklayer)
  #Manual read in of locAnn
  #load("C:/Users/Nick/Documents/PhD/Projects/Chlamy/segD_chlamy_segmentation_LociRun2018_multi200_gap100.RData")
  #fdr=0.1
  #loci <- selectLoci(cD = segD, FDR = fdr, perReplicate = TRUE)
  #locAnn <- loci@coordinates
